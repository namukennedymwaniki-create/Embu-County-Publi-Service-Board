...
ROLE_PERMISSIONS = {
    ...
    "Admin": {
        ...
        "permissions": [
            "view_dashboard", "view_ai_kb", "test_gcs_connection", "upload_ai_documents", "view_staff", "add_staff", "edit_staff", "delete_staff",
            "import_staff", "process_promotions", "manage_redesignation", "manage_contracts",
            "manage_translation", "manage_salary", "manage_leave", "manage_confirmation",
            "manage_discipline", "manage_acting", "view_reports", "export_data",
            ...
            with st.form("add_employee_form_hr"):
                ...
                with col2:
                    department = st.selectbox("Department", 
                        ["Administration", "Finance & Economic Planning", "Trade and Tourism", "ICT", "Health", "Education", "Public Works", "Agriculture", "ECRA", "Environment", "Office of The Governor", "Lands", "Other"],
                        key="hr_department")
        ...
        with tab_view:
            ...
            with col2:
                search_department = st.selectbox("Filter by Department", 
                    ["All Departments", "Administration", "Finance & Economic Planning", "Human Resource", "ICT", "Health", "Education", "Public Works", "Agriculture", "Lands", "Trade and Tourism", "ECRA", "Water", "Environment", "Gender", "Youth", "Cooperative", "Energy", "Transport", "Legal", "Audit", "Procurement", "Other"],
...
def records():
    ...
    # =========================================================
    # SUPER ADMIN DELETE FUNCTIONALITY - MOVED TO BOTTOM
    # =========================================================
    if st.session_state.user["role"] == "Super Admin":
        ...
        ">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                <span style="font-size: 24px;">⚠️</span>
                <h3 style="color: #ef4444; margin: 0;">SUPER ADMIN ACTIONS</h3>
            </div>
            <p style="color: #fca5a5; margin: 0;">These actions are permanent and cannot be undone! Use with extreme caution.</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            if st.session_state.advanced_search_triggered and st.session_state.advanced_results is not None:
                ...
                if not current_display_df.empty:
                    ...
                    st.info("No records in the current view to delete.")
            else:
        ...
        with st.expander("🔄 Recovery Options"):
            ...
            **To restore a deleted record:**  
            1. Check the Audit Trail for the deletion details  
            2. Contact the database administrator to restore from backup  
