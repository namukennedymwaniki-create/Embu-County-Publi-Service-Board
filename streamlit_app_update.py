                        ...
                        if st.button("📊 Generate Consolidated Report", use_container_width=True):
                            ...
                            if filtered_for_report.empty:
                                ...
                                if all_staff:
                                    ...
                                    # =========================================================
                                    # AUDIT LOG - LOG THE REPORT GENERATION
                                    # =========================================================
                                try:
                                    audit_details = f"""
                                    CONSOLIDATED REPORT GENERATED:
                                    - Report Type: Staff Returns Consolidated Report
                                    - Department Filter: {report_dept}
                                    - Month Filter: {report_month}
                                    - Year Filter: {report_year}
                                    - Total Returns: {len(filtered_for_report)}
                                    - Total Departments: {len(department_summary)}
                                    - Total Staff: {len(consolidated_df)}
                                    - Generated By: {st.session_state.user['username']}
                                    ...
                                    print(f"✅ Audit log: CONSOLIDATED_REPORT generated by {st.session_state.user['username']}")
                                except Exception as e:
