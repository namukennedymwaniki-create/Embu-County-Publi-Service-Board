...
# ==================== TAB 4: PROMOTIONS (TEST VERSION) ====================
with hr_tab4:
    st.subheader("📈 Promotions Management")
    st.success("✅ PROMOTIONS TAB IS LOADING!")
    ...
    with promo_subtab1:
        st.write("### Common Establishment Sub-Tab is Working!")
        st.info("This is the existing promotion functionality")
    
    with promo_subtab2:
        st.write("### Internal Recruitment Sub-Tab is Working!")
        st.info("This is the new internal recruitment functionality")
...
def data_entry():
    ...
    # Variable to store found position - CRITICAL: Initialize here
    found_position = None
...
# =====================================================
# APPLICANT REGISTRATION (RECRUITMENT) - UPGRADED 7-TAB VERSION
# =====================================================
def data_entry():
    st.markdown("""
    <div class="main-header">
            ...
            if errors:
                ...
                try:
                    ...
                    """, (
                        ...
                        contact, year_completed if year_completed else 0,
                        qual_summary,
                        ...
                        position_applied, advertisement_ref,
                        email, 0, "",
